...
Media remains local. This installer downloads code, CrispASR binaries, and only
explicitly requested allowlisted model files from the documented sources. It
never uploads media.
